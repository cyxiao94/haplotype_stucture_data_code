...
#sample size(n) 25 50 100 400 800
#selection target(t) 10
#t_sc t10_sc10.0
...
run_slim_simulation(){
  ...
  do
    ...
    do
      ...
      slim -s ${seed} \
         -d "vcffile='/home/cxiao/data/04Dsim_SA_flucVScons/06slim_2025/01simulation_10runs_chr2L/01generate_founder_population/08vcffile_simulationC_LD/run${runs}_n${num_sample}_${num_target}loci_s10_${pop}.vcf'" \
...
for runs in {1..10}
do
  for num_sample in 400 800 1200 2500
  do
    for num_target in 100
    do
      for strength in 10
      do
