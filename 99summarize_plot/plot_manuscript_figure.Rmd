...
'1c AFC correlation time-series'
'1d AFC corrlation matrix (F80)'
### 1b PCA
```{r}
#load PCA values
...
plot(p_box)
ggsave("Figures_manuscript/Figure1c_AFC_correlation_timeseries.pdf", plot = p_box, width = 3, height = 3)
```

### 1d AFC correlation matrix
```{r}
cor_afc <- fread('../07empirical_results/03AFC_cor/2818_AFC_cor.txt.gz', header = TRUE)
...
#visualisation
pdf("Figures_manuscript/Figure1d_AFC_correlation_F80.pdf", width = 8, height = 8)
...
'5b PCA of genomic response from two environments(fluctuating and constant)'
'5c AFC correlation matrix (F80)'
###5b PCA
```{r}
...
plot(p_pca12)
ggsave("Figures_manuscript/Figure5b_fluc_cons_PCA12.pdf", plot=p_pca12, width = 8, height = 6)
...
###S1a Venn Diagram
```{r}
af<-fread('../../01simulation_10runs_chr2L/07empirical_results/00data/biallelic.max15.min85.SA.hfluc_hcons.F0-F80.flt.af.txt.gz', select = 1:19)
...
---------------------------------------------------------------------------------
#Simulation B_identical starting frequency
##Figure 3.shuffle genotype to have identical frequency
...
##FigureS7_simulationB_LD_PCA
'shuffle genotype'
'code in plot_simulation.Rmd'


##FigureS8_simulationB_LD_AFC_correlation
'shuffle genotype'
'code in plot_simulation.Rmd'

##FigureS9_simulationB_LE_PCA
'shuffle genotype'
'code in plot_simulation.Rmd'

##FigrueS10_simulationB_LE_AFC_correlation
'shuffle genotype'
'code in plot_simulation.Rmd'
...
###FigureS11_simulationC_LD_PCA
'sample size'
'code in plot_simulation.Rmd'

###FigureS12_simulationC_LD_AFC_correlation
'sample size'
'code in plot_simulation.Rmd'
